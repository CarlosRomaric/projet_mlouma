...
@if($isOpen)
        <div class="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div class="relative bg-gray-100 p-8 rounded shadow-lg w-1/2">
                ...
                <h2 class="text-2xl font-bold mb-4">{{ $roleId ? 'Modification de role' : 'Creation de role' }}</h2>
                <form wire:submit.prevent="{{ $roleId ? 'update':'saveRole' }} ">
                    ...
                    <div class="flex gray-400 mb-6">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                name="name" id="name"  wire:model="name" type="text" placeholder="Nom du role" value="{{ old('name') }}">
