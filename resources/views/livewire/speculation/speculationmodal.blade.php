...
@if($isOpen)
        <div class="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div class="relative bg-gray-100 p-8 rounded shadow-lg w-1/2">
                ...
                <h2 class="text-2xl font-bold mb-4">{{ $speculationId ? 'Modification de speculation' : 'Creation de speculation' }}</h2>
                <form wire:submit.prevent="{{ $speculationId ? 'update':'saveSpeculation' }} ">
                    ...
                    <div class="flex gray-400 mb-6">
                        ...
                        <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input
                                ...
                                name="name" id="name"  wire:model="name" type="text" placeholder="Nom du speculation" value="{{ old('name') }}">
...
@if($isOpenDelete)
        <div class="fixed inset-0 flex items-center justify-center z-50">
            ...
            <div class="relative bg-gray-100 p-8 rounded shadow-lg w-1/2">
                ...
                <h2 class="text-2xl font-bold mb-4">Voulez vous supprimer cet speculation ?</h2>
                <div class="flex justify-end mt-5">

                        <button type="button" class="btn-green-table hover:bg-green-800 text-white font-bold py-2 px-4 rounded mr-2" wire:click='delete("{{$speculationId}}")'>Valider</button>
