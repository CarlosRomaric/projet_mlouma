@extends('layouts.app')
@section('title') - Liste des parcelles @endsection
@section('content')
...
<div class="container py-5 px-20 mx-auto md:px-20  md:container md:mx-auto content">
        ...
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                <li class="inline-flex items-center">
                    <a href="{{ route('farmers.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-green-600 dark:text-gray-400 dark:hover:text-white">
        ...
        <div class="pt-10">
            ...
            @livewire('plot.plot-component', ['farmerId' => $farmerId]) 
